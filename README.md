...
_Your Trusted Medical Platform in Egypt for Health Consultations_
...
├── models/               # Mongoose schemas (Doctor, Patient, etc.)
...
_Built with ❤️ for the Egyptian healthcare community_
