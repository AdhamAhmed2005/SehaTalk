...
const getContent = (lang) => ({
  ...
  allSpecialties: lang === 'en' ? "All Medical Specialties" : "جميع التخصصات الطبية",
  questionsLabel: lang === 'en' ? "questions" : "سؤال",
  explore: lang === 'en' ? "Explore →" : "استكشف ←",
  trending_badge: lang === 'en' ? "Trending" : "شائع",
  cta: {
    title: lang === 'en' ? "Can't Find Your Category?" : "لا تجد التصنيف المناسب؟",
    description: lang === 'en'
    ...
    browseQuestions: lang === 'en' ? "Browse All Questions" : "تصفح جميع الأسئلة"
  }
});
