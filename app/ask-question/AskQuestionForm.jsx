...
import { validateQuestionForm } from "../../lib/utils/questionUtils.js";
...
export function AskQuestionForm({ patientProfile }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      router.push(`/dashboard/patient?newQuestion=${questionId}&success=true`);
    } catch (error) {
          ...
          >
            ...
            <div>
              <Label
                ...
                className={`text-blue-900 font-medium mb-2 block ${
              ...
              <textarea
                ...
                className={`medical-input min-h-20 resize-none text-gray-900 placeholder:text-gray-500 w-full p-4 border-2 border-blue-200 rounded-xl focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all ${
                  isRTL ? "text-right" : "text-left"
                }`}
                rows={3}
                dir={isRTL ? "rtl" : "ltr"}
