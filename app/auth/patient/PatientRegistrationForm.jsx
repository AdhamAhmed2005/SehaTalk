          ...
          {step === 1 && (
            <div>
              <div className="text-center mb-8">
                ...
                <p className="text-blue-700">Let's start with your basic details</p>
              </div>
          ...
          {step === 2 && (
            <div>
              <div className="text-center mb-8">
                ...
                <h2 className="text-2xl font-bold text-blue-900 mb-2">Medical History</h2>
                <p className="text-blue-700">Help our doctors provide better care by sharing your medical background</p>
              </div>

              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <Label htmlFor="height" className="text-blue-900 font-medium">Height (cm)</Label>
                ...
                <div>
                  <Label htmlFor="weight" className="text-blue-900 font-medium">Weight (kg)</Label>
                  <div className="relative mt-2">
                ...
                <div>
                  <Label className="text-blue-900 font-medium">Blood Type</Label>
                ...
                <div className="md:col-span-2">
                  <Label htmlFor="allergies" className="text-blue-900 font-medium">Known Allergies</Label>
                  <textarea
                    id="allergies"
                ...
                <div className="md:col-span-2">
                  <Label htmlFor="currentMedications" className="text-blue-900 font-medium">Current Medications</Label>
                  <textarea
                ...
                <div className="md:col-span-2">
                  <Label htmlFor="chronicConditions" className="text-blue-900 font-medium">Chronic Conditions</Label>
                  <textarea
                ...
                <div className="md:col-span-2">
                  <Label htmlFor="previousSurgeries" className="text-blue-900 font-medium">Previous Surgeries</Label>
                  <textarea
          ...
          {step === 3 && (
            <div>
              <div className="text-center mb-8">
                ...
                <h2 className="text-2xl font-bold text-blue-900 mb-2">Emergency Contact & Final Details</h2>
                <p className="text-blue-700">Almost done! Please provide emergency contact information</p>
              </div>

              <div className="grid md:grid-cols-2 gap-6">
                <div className="md:col-span-2">
                  <h3 className="text-lg font-semibold text-blue-900 mb-4">Emergency Contact Information</h3>
                </div>
                <div>
                  <Label htmlFor="emergencyContactName" className="text-blue-900 font-medium">Contact Name *</Label>
                  <Input
                ...
                <div>
                  <Label htmlFor="emergencyContactPhone" className="text-blue-900 font-medium">Contact Phone *</Label>
                  <Input
                ...
                <div>
                  <Label className="text-blue-900 font-medium">Relationship *</Label>
                ...
                <div>
                  <Label className="text-blue-900 font-medium">Exercise Frequency</Label>
                  <Select value={formData.exerciseFrequency} onValueChange={(value) => handleInputChange('exerciseFrequency', value)}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="4-6-weekly">4-6 times per week</SelectItem>
                      <SelectItem value="2-3-weekly">2-3 times per week</SelectItem>
                ...
                <div className="md:col-span-2">
                  <Label htmlFor="familyMedicalHistory" className="text-blue-900 font-medium">Family Medical History</Label>
                  <textarea
              ...
              <div className="mt-8 p-6 bg-blue-50 rounded-lg">
                <h4 className="font-semibold text-blue-900 mb-3">Privacy & Terms</h4>
                <div className="text-sm text-blue-700 space-y-2">
                  <p>• Your medical information is encrypted and stored securely</p>
                  <p>• Only verified doctors you interact with will see relevant medical details</p>
                  <p>• You can update or delete your information at any time</p>
                  <p>• We follow strict medical privacy regulations (HIPAA equivalent)</p>
                </div>
                <div className="mt-4 flex items-start gap-3">
                  <input type="checkbox" id="terms" className="mt-1" />
                  <label htmlFor="terms" className="text-sm text-blue-700">
                    I agree to the <Link href="/privacy" className="text-primary hover:underline">Terms of Service</Link> and <Link href="/privacy" className="text-primary hover:underline">Privacy Policy</Link>, and consent to the secure storage of my medical information.
                  </label>
                </div>
              </div>
